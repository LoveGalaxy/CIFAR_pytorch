...
def resnext50_32x4d(num_classes, pretrained=False, progress=True, **kwargs):
    ...
    return _resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3], num_classes,
                   pretrained, progress, **kwargs)


def resnext101_32x8d(num_classes, pretrained=False, progress=True, **kwargs):
    ...
    return _resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3], num_classes,
                   pretrained, progress, **kwargs)
